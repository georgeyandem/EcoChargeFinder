function LogInView(props) {
  ...
  <section class="bg-gray-50 dark:bg-gray-900">
    ...
    <img class="w-8 h-8 mr-2" src="./EcoChargeFinder_icon.png" alt="logo"/>
          EcoChargeFinder    
      </a>
        ...
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form class="space-y-4 md:space-y-6" id="loginForm">
            ...
            <div class="flex items-center justify-between">
              <button class="text-sm font-medium text-primary-600 hover:underline dark:text-primary-500"  onClick={resetACB}>Forget your Password</button> 
            </div>
            <button class="w-full text-white bg-blue-500 hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-800" onClick={loginACB}>Sign in</button>
            <div class="my-4 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-neutral-300 after:mt-0.5 after:flex-1 after:border-t after:border-neutral-300">
              <p class="mx-4 mb-0 text-center font-semibold dark:text-white"> OR</p>
            </div>
            <button class="w-full text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-800" onClick={googleACB}>Sign in with Google</button>
            <p class="text-sm font-light text-gray-500 dark:text-gray-400 mb-4 "> Don’t have an account yet? 
            <button class="font-medium text-primary-600 hover:underline dark:text-primary-500" onClick={signupACB}>Signup</button> </p>
          </form>
        </div>
      </div>
    </div>
